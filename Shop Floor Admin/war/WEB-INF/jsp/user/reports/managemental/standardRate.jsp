...
<head>
<title>Shop Floor - Standard Rate Report</title>
</head>
...
<div id="content">
	...
	<br> <br> 
	<CENTER>
		<font size="2"> <b> <fmt:message key="table.StandardRate.header"/> </b> </font>
	</CENTER>  
 <br> <br>
 <CENTER>
		<font size="2"> <fmt:message key="table.std.column14"/> :<c:out value='${command.partid} - ${command.partDesc}'></c:out> </font>				
	</CENTER>
...
<c:when test='${empty command.standardRateReport}'>
	...
	<TABLE id="normalTableNostripe" align="center" cellSpacing="0" cellPadding="0" border="0" style="white-space: nowrap; word-spacing: normal;">
			<thead class="fixedHeader">
					<tr class="selected" height="15px">						
					    <th class="tableTitle" width="90"> <fmt:message key="table.std.column15"/> </th>
						<th class="tableTitle" width="90"> <fmt:message key="table.std.column4"/> </th>
						<th class="tableTitle" width="90"> <fmt:message key="table.std.column5"/> </th>
						<th class="tableTitle" width="90"> <fmt:message key="table.std.column6"/> </th>
						<th class="tableTitle" width="90"> <fmt:message key="table.std.column7"/> </th>
						<th class="tableTitle" width="90"> <fmt:message key="table.std.column8"/> </th>
						<th class="tableTitle" width="90"> <fmt:message key="table.std.column9"/> </th>
						<th class="tableTitle" width="90"> <fmt:message key="table.std.column10"/> </th>
						<th class="tableTitle" width="90"> <fmt:message key="table.std.column11"/> </th>	
						<th class="tableTitle" width="90"> <fmt:message key="table.std.column12"/> </th>			
						<th class="tableTitle" width="90"> <fmt:message key="table.std.column13"/> </th>														
					</tr>
		</thead>
		<tbody class="scrollContent">
					<c:forEach items="${command.standardRateReport}" var="data" varStatus="list">
					...
					<c:choose>
						...
						<c:otherwise>
							<td class="tableContent" width="30" style="width:2160px;white-space: nowrap; word-spacing: normal;"> <c:out value="${data.assetDesc}"></c:out> </td>
						</c:otherwise>				
					</c:choose>
					...
					<c:choose>
						...
						<c:otherwise>
							...
							&itemNo=${data.partid}&punchIn=${command.fromDate}&punchOut=${command.toDate}','dialogWidth:900px; dialogHeight:410px; center:yes')"  
