...
<TABLE border="0" cellpadding="0" cellspacing="0" width="100%"
	...
	<tr valign="top">
		<td rowspan="4" valign="center" size="5"
			...
			<table width="100%">
						<tr>	<td>Facility</td><td>Cost Center</td></tr>
						<tr>	
						<td>
								...
								<select name="facility" id="facility" onchange="javascript:getCostCenters();" >
									...
									<td>
											<select 	name="costCenter"
															style="width:220px;margin:5px 0 5px 0;font: small-caps 900 10px arial;color:#1A4A6F;"
															size="6">
												<c:forEach items="${command.costCenters}" var="data" varStatus="list">
													<option value="${data.costCenterCode}" <c:if test="${command.costCenter eq data.costCenterCode}"> <c:out value="selected"/> </c:if> >
														<!-- Ramanan.M - 30th Aug  : Added a - Between the Cost Center and the Cost Center Description -->
...
cal2.top = 300;
	...
	<c:when test="${not empty command.costCenter}">
