...
<div id="content">
	...
	<br> <br> 
	<CENTER>
		<font size="2"> <b> Asset Summary </b> </font>
	</CENTER>  

<c:choose>

<c:when test='${empty command.factoryAssetPopUpReport}'>
...
<CENTER>
	<TABLE id="normalTableNostripe" align="center" cellSpacing="0" cellPadding="0" border="0" style="white-space: nowrap; word-spacing: normal;">
		...
		<tbody class="scrollContent">
					<c:forEach items="${command.factoryAssetPopUpReport}" var="data" varStatus="list">
