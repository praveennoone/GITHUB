...
DateChooser.prototype.show = function() {
    ...
    //this._div.style.top = "250px";
	//this._div.style.left = "400px";
...
DateChooser.prototype.createCalendarHtml = function() {
    ...
    return result + "\r\n  </tr>\r\n</table><!--[if lte IE 6.5]><iframe style='visibility:visible; z-index:999; position:absolute; top:-500px; left:-500px;'></iframe><![endif]-->";
}
